...
<body>
    ...
    <?php
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            $dataerror = true;
            $alertmessages = "this username is already exist...";
            }elseif($pass !== $repass){
                $dataerror = true;
            $alertmessages ="two password intered in input is must be same";
            }else{
                $mypass = password_hash($pass,PASSWORD_DEFAULT);
                $newInset = "INSERT INTO profile(username,password) VALUES('$username','$mypass')";
                mysqli_query($cnct,$newInset);
                header('Location: login.php');
            }
        }
        if($dataerror){
           echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">
           <strong>Hy kopal pora!</strong> '. $alertmessages.'
